...
<div class="about-section">
    <h3 class="about-section-title">
        <span class="about-section-icon"><i class="fa-brands fa-github" aria-hidden="true"></i></span> GitHub Activity
    </h3>
...
<div class="about-section">
    <h3 class="about-section-title">
        <span class="about-section-icon"><i class="fa-regular fa-envelope" aria-hidden="true"></i></span> Contact
    </h3>
...
<div class="about-section">
    ...
    <div class="timeline">
        ...
        <div class="timeline-item">
            ...
            <div class="timeline-content">
                <span class="timeline-date">2023 ~</span>
                <h4 class="timeline-title">Backend Development</h4>
                <p class="timeline-desc">Studying Spring Boot, JPA/Hibernate, and REST API design. Adopted Kotlin as primary language and exploring the JVM ecosystem.</p>
            </div>
        </div>
        <div class="timeline-item">
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <span class="timeline-date">2023</span>
                <h4 class="timeline-title">Tech Blog Launch</h4>
                <p class="timeline-desc">Built a developer blog with Jekyll + GitHub Pages. Implemented dark mode, responsive design, and PWA from scratch.</p>
            </div>
        </div>
        <div class="timeline-item">
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <span class="timeline-date">2023</span>
                <h4 class="timeline-title">Algorithms & Data Structures</h4>
                <p class="timeline-desc">Deep dive into advanced algorithms: Segment Trees, Floyd-Warshall, MST. Building strong CS fundamentals.</p>
            </div>
        </div>
    </div>
</div>
